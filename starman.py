...
word_list = [["S","T","A","R","D","U","S","T"], ["R","U","B","Y","T","U","E","S","D","A","Y"], ["S","I","L"\
,"V","E","R","B","E","A","T","L","E","S"]]
spacePicture = [["\
.........................=MMMMM?............................","\
...................MOM MMMMMMMMMMMMMM7.  .   . .","\
...
..........??+..........................................77~,:?+???,~?,77~77777...........................................","\
...777777..+?++,.......................................77.?=??+:???::77?777777..........................................","\
...7777777I,++++?......................................77,,??~~~=,+:?:7777777777777=....................................","\
...7777777..?++++++...................................77I:+?,~,:~~?,??77.I77777777777777.7777...........................","\
..=7777777..++++?++?+...............................77777,...,,:=?I77I7777..,::,,......?7I777777777I:...................","\
...7777777..+++++++++++??+.+++++++++++?+++++~~=77777777777777777777777777777=...,,,,,....,,:,,....,,~~~~~,++++++++......","\
...7777777..?+++++++++++++.+++++++++++??+++?~~.7777777777777777777777777:~~~~:,,,,,,,,,,:::~~~~~~~~~~:,,++?,=::++++?....","\
...7777777..++++++++++++++:++++++++++:++++++,~:777777777777777777777777.~~?:,:,+,,::,+:,:,?,,:,,++++++++++,=====:++++...","\
...7777777..?+++++++++++++?.++++++++=?++++++?~~,7777777777777777777777.:~?.,::,::::::,,:::,::::,++++++++++++,~=~?++++...","\
..=77I77,..?++++++++++++++++++++++++++++++??+?:~~.7777777777777777777.~~~++:,,,+=,:,?+,,,:+?.,:,++++++++++++++++++++....","\
..:?++++?++?++++++++++++++++++++++++++++++?,~~~~~~~~~~~~~~~~~~~~~~~~~~,++++++++++++++++++++++++++++++++++++++++++++.....","\
...................+++++++++++++++++++++?:~~~,,.,,,,,.,.,,.,,~,,=+++,.++++++++++++++++++++....,~++++++++++++++++........","\
.................:..?++++++++++++++++++~~~,+++++++,,::::,::,+~::::.:::,++++++++++++++++.+++++++++++?:?++++++++~.........","\
....................+++++++++++++++++++:~:++++++++:::::,:::,::::::.,::,,+++++++++++++++?++++++++++++?.++++++++..........","\
    ...
    while (count < len(word)) and (spaceman < 7):
        ...
        if n == 0:
            ...
            if count == len(word):
                ...
                play_mp3("./goodbyerubytuesday.mp3")
                game(n+1)
        elif n == 2:
            if spaceman == 5:
                print("Sorry, you lost. Goodbye!")
                play_mp3("./goodbyegoodbye.mp3")
                spaceman == 7
            if count == len(word):
